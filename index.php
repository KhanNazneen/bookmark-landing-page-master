...
<body>
      ...
      <a href="/">
        <svg width="148" height="25" xmlns="http://www.w3.org/2000/svg">
          <g fill="none" fill-rule="evenodd">
            ...
            <g>
              <circle class="path-1" fill="#5267DF" cx="12.5" cy="12.5" r="12.5" />
              <path class="path-2" d="M9 9v10l3.54-3.44L16.078 19V9a2 2 0 0 0-2-2H11a2 2 0 0 0-2 2z" fill="#FFF" />
            </g>
          </g>
        </svg>
      </a>
  ...
  <main>
    <section id="features">
      <div class="features-aim">
        ...
        <ul role="tablist" class="features-aim-lists">
  ...
  <footer>
    <div class="footer-nav">
      <img src="./images/logo-white-bookmark.svg" alt="logo-bookmark">
